...
sqlite_version_test() ->
    ...
    ?assertEqual({row, {<<"3.34.0">>}}, esqlite3:step(Stmt)),
    ok.
...
sqlite_source_id_test() ->
    ...
    ?assertEqual({row, {<<"2020-12-01 16:14:00 a26b6597e3ae272231b96f9982c3bcc17ddec2f2b6eb4df06a224b91089fed5b">>}}, esqlite3:step(Stmt)),
    ok.
